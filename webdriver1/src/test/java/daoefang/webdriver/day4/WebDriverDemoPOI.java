...
public class WebDriverDemoPOI {
	...
	@Test(description = "测试后台添加会员功能", dataProvider = "abc123", dependsOnMethods = { "testLogin" })
	...
	public Object[][] generateData() throws IOException {
		return POIDataDrivenDemo.getTestDataFromXls("data/TestData1.xls");
		// return POIDataDrivenDemo.getTestDataFromExcel("data/TestData1.xlsx");
	}
}
